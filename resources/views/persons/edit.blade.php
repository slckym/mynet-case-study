                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control" id="birthday" name="birthday"
                                               ...
                                               value="{{ old('birthday')?:$person->birthday->format('Y-m-d') }}"
                                        >
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control " name="gender" id="gender">
                                            ...
                                            @foreach(\App\Enums\GenderEnum::getGenders() as $key => $gender)
                                                <option
                                                    {{($gender === $person->gender) ? "selected" : null}}
                                                    value="{{$key}}">{{__($gender)}}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" id="address" name="address"
                                               ...
                                               value="{{ old('address')?:$person->address->address }}"
                                        >
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div
                                                ...
                                                <input class="form-control" id="post_code" name="post_code"
                                                       ...
                                                       value="{{ old('post_code')?:$person->address->post_code }}"
                                                >
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div
                                                ...
                                                <input class="form-control" id="city_name" name="city_name"
                                                       ...
                                                       value="{{ old('city_name')?:$person->address->city_name }}"
                                                >
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div
                                                ...
                                                <input class="form-control" id="country_name" name="country_name"
                                                       ...
                                                       value="{{ old('country_name')?:$person->address->country_name }}"
                                                >
                                            </div>
                                        </div>
                                    </div>
